  ...
  <div class="app-container">
    <PageTool>
      <el-form label-width="110px" ref="searchForm" :model="searchForm">
        <el-col :span="8">
          <el-form-item label="取件任务编号:" prop="id">
            <el-input placeholder="请输入取件任务编号" v-model="searchForm.id" clearable/>
          </el-form-item>
        </el-col>
        <el-col :span="8">
    ...
    <tabs-group @tab-click="tabClick" :activeTab="activeTab">
      ...
      <table-item name="已取消" :value="3"></table-item>
    </tabs-group>
    ...
    <el-card shadow="never" v-loading="loading">
      ...
      <el-table :data="tableData" stripe style="width: 100%">
        ...
        <el-table-column prop="id" label="取件作业编号" width="180"/>
